...
{
    public partial class EmployeeEditLogin : Form
    {
        int gvnlkkod;
        public string Tc_no;
        BlUserLogin _blUserLogin;
        public EmployeeEditLogin()
        {
            InitializeComponent();
            txtKAd1.MaxLength = 9;
            txtKAd2.MaxLength = 9;
            txtSifre1.MaxLength = 9;
            txtSifre2.MaxLength = 9;
            txtGuvenlik.MaxLength = 6;
            _blUserLogin = new BlUserLogin();
            this.AcceptButton = btnGuncelle;
        }
        private void LoginEmployee_Load(object sender, System.EventArgs e)
        {
